...
exports.run = async (client, message) => {
    ...
    let cmdUsage = client.commands.get("raidkick", "help.usage");
    ...
    let msg = await client.channels.get(client.botGuilds.get(message.guild.id).raidChannel).fetchMessage(client.userRaids.get(message.author.id));
